...
ShowUsage() {
    ...
    echo "Options:"
    echo "  -d/--dest: Where to build ffmpeg (Optional, defaults to ./ffmpeg-nvenc)"#!/bin/bash
...
InstallDependencies() {
   ...
   sudo zypper in -y autoconf automake libass-devel libfreetype6 libgpac-devel \
       ...
       libcurl-devel libfdk-aac1  fdk-aac-devel libopus-devel libx264-devel libQt5Widgets-devel libqt5-qtx11extras-devel 
}
